...
public class AAA {
	public static void main(String[] args) {
		IGtPush push = new IGtPush(GetuiInfo.APP_KEY, GetuiInfo.MASTER_SECRET, true);
...
//		NotyPopLoadTemplate template = notyPopLoadTemplateDemo("","");
		...
		target.setAppId(GetuiInfo.APP_ID);
	...
	public static LinkTemplate linkTemplateDemo() {
		...
		// 设置APPID与APPKEY
		template.setAppId(GetuiInfo.APP_ID);
		template.setAppkey(GetuiInfo.APP_KEY);
